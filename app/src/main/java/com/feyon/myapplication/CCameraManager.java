...
/**
 * Created by DS on 2018/6/1.
 */

public class CCameraManager {
    private static CCameraManager instance;
    ...
    private CCameraManager() {

    }

    public static CCameraManager getInstance() {
        if (instance == null) {
            instance = new CCameraManager();
        }
        return instance;
    }

 ...
 * 确认 取消 Dialog
 */
public class MdDialogSureCancel extends RootDialog {
    ...
    public MdDialogSureCancel(Context context, int themeResId) {
        super(context, themeResId);
        initView();
    }

    public MdDialogSureCancel(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        initView();
    }

    public MdDialogSureCancel(Context context) {
        super(context);
        initView();
    }

    public MdDialogSureCancel(Activity context) {
        super(context);
        initView();
    }

    public MdDialogSureCancel(Context context, float alpha, int gravity) {
